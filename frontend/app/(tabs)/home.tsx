...
const styles = StyleSheet.create({
  ...
  dineInCard: { marginHorizontal: SPACING.l, marginTop: SPACING.m, backgroundColor: COLORS.secondary.default, borderRadius: RADIUS.xl, padding: SPACING.l, flexDirection: 'row', alignItems: 'center', ...SHADOWS.medium },
  dineInLeft: { flex: 1 },
  dineInBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#FFF3', paddingHorizontal: 10, paddingVertical: 4, borderRadius: RADIUS.full, alignSelf: 'flex-start', marginBottom: SPACING.s },
  dineInBadgeText: { fontSize: FONT_SIZE.small, fontWeight: '700', color: '#FFF' },
  dineInTitle: { fontSize: FONT_SIZE.h3, fontWeight: '800', color: '#FFF' },
  dineInPrice: { fontSize: FONT_SIZE.h1, fontWeight: '800', color: '#FFF', marginTop: SPACING.xs },
  dineInDesc: { fontSize: FONT_SIZE.caption, color: '#FFF', opacity: 0.9, marginTop: SPACING.xs, fontWeight: '600' },
  dineInIncludes: { fontSize: 11, color: '#FFF', opacity: 0.75, marginTop: SPACING.xs },
  dineInBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderRadius: RADIUS.full, paddingVertical: 10, paddingHorizontal: SPACING.m, marginTop: SPACING.m, alignSelf: 'flex-start', gap: 6 },
  dineInBtnText: { fontSize: FONT_SIZE.caption, fontWeight: '700', color: COLORS.secondary.dark },
  dineInEmoji: { fontSize: 64, marginLeft: SPACING.s },
